## Содержание
1. [Вариант 1 ](## Вариант 1)
2. [Вариант 2 ](## Вариант 2)
3. [Вариант 3 ](## Вариант 3)
4. [Вариант 4 ](## Вариант 4)
5. [Вариант 5 ](## Вариант 5)
6. [Вариант 6 ](## Вариант 6)
7. [Вариант 7 ](## Вариант 7)
8. [Код вставки БД](## БД)
...
### Задание 3
```SQL
SELECT first_name as Имя, last_name as Фамилия,(upper(substr(First_name,1,3))|| upper(substr(Last_name,1,2)))as Идентификатор FROM employees;
```
### Задание 4
